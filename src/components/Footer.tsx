      ...
      <div className="max-w-[1440px] mx-auto px-8">
        <div className="grid grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed">Alta medicina estética em São Paulo. Protocolos exclusivos para resultados reais.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/tratamentos" className="text-bg-blush hover:text-accent-gold transition-colors text-sm">Criolipólise</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[rgba(196,149,106,0.1)] pt-8 flex justify-between items-center">
          <p className="text-text-muted text-sm">&copy; 2026 Velour Clinic. Todos os direitos reservados.</p>
          <div className="flex gap-6">
            <span className="text-text-muted text-sm hover:text-accent-gold cursor-pointer transition-colors">Instagram</span>
            <span className="text-text-muted text-sm hover:text-accent-gold cursor-pointer transition-colors">Facebook</span>
            <span className="text-text-muted text-sm hover:text-accent-gold cursor-pointer transition-colors">LinkedIn</span>
          </div>
        </div>
      </div>
    </footer>
