  ...
  return (
    <main>
      ...
      <section className="bg-bg-primary pt-32 pb-20 min-h-screen">
        <div className="max-w-[1440px] mx-auto px-8 grid grid-cols-[55%_45%] gap-16 items-center">
          <div>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-8 left-8 bg-white rounded-2xl p-6 shadow-[0_20px_60px_rgba(196,149,106,0.12)]">
              <div className="flex items-center gap-3">
                <span className="text-2xl">⭐</span>
                <span className="font-body font-semibold text-text-primary">4.9 · 847 pacientes transformadas</span>
              </div>
            </div>
          </div>
        </div>
